...
function layerCleanerOptions(){
    ...
    var optionsGroup = cleanLayerOptnsDlg.add( "Panel" , undefined , "Delete : " );
        optionsGroup.margins = [ 10 , 13 , 5 , 5 ];
    ...
    var resetOptionGroup = cleanLayerOptnsDlg.add( "Group" );
        resetOptionGroup.margins = [ 10 , 6 , 5 , 3 ];
        var resetLayerTransform = resetOptionGroup.add( "Checkbox" , undefined , " - Reset Layer." );
