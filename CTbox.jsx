    ...
    globalGroup.alignment = [ "left" , "top" ];
        ...
        var btnsSize = [ 75 , 25 ];
            ...
            Block02.visible = false ;
                var B2Btn01 = Block02.add( "button" , undefined , { en: "Loc. Bot." , fr: "Def. Bas" } );
                B2Btn01.helpTip = "   Locates the Content lowest point in the layer, for the length of the active layer.\n   Adds a point Effect to the layer.\n   ALT + Click > \"Get Lowest Layer Point Options\".";
                ...
                B2Btn04.helpTip = "   Click > Creates an outside Rim Light in Overlay Mode.\n   ALT + Click > Creates an inside Rim Light in Multiply Mode." ;
