...
function CTbuildUI( thisObj ){
    ...
    var CTboxVersion = "1.2.0"//x.y.z - x > major change | y > addition of a fonctionnality | z > debug.
    //Creating the UI
    var CTpanel = thisObj ;
    ...
    globalGroup.alignChildren = "Fill" ;
        ...
        BlockXX.orientation = "Column";
            ...
            versionBlock.margins = [ 10 , 2 , 10 , 2 ];
            versionBlock.orientation = "Row";
            versionBlock.spacing = 0 ;
