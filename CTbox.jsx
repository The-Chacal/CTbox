...
function CTbuildUI( thisObj ){
    ...
    var CTboxVersion = "CTbox v1.2.16"//Released//x.y.z - x > major change | y > addition of a fonctionnality | z > debug.
